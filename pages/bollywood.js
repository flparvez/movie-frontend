...
const bollywoodData = publishedMovies.filter(movie => movie.category === 'bollywood');
    ...
    return <>
        ...
        <section className="genrenamesec">
            <div className="genrename">
                <h1>Movies</h1>
                <p>Exclusive bollywood movies Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugit adipisci natus unde.</p>
